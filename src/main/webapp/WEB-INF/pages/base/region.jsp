...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/region_pageQuery.do",
			method:"get",
			idField : 'id',
			columns : columns,
		...
		$('#button-import').upload({
			...
			action : '${pageContext.request.contextPath}/region_batchImport.do', // 目标路径
			autoSubmit : true, // 自动提交
			params : {}, // 其它参数
			onComplete : function(response){
				// $.post 回调函数 data 是经过处理的
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="区域添加修改" id="addRegionWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="regionForm" action="${pageContext.request.contextPath }/reqion_save.do" method="post"> 
